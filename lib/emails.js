...
export async function sendWaitlistConfirmation({ to, lang }) {
  ...
  return send({
    to,
    subject: isEn
      ? '◈ You are on the list — ADS-SQUARE'
      : '◈ Vous êtes sur la liste — ADS-SQUARE',
    html: base({
      preheader: isEn
        ? 'Your place on the ADS-SQUARE waitlist is confirmed. We\'ll notify you as soon as it opens.'
        : 'Votre place sur la liste d\'attente ADS-SQUARE est confirmée. On vous prévient dès l\'ouverture.',
      accentColor: '#E8A020',
      body: `
        <div style="text-align:center;margin-bottom:24px;">
          <div style="display:inline-block;width:56px;height:56px;
        ...
        <div style="margin-top:12px;margin-bottom:24px;">
          ${subText(isEn
            ? `Your email has been registered for priority access to ADS-SQUARE.<br><br>
            ...
            : `Votre email a bien été enregistré pour l'accès prioritaire à ADS-SQUARE.<br><br>
...
export async function sendWaitlistAdminNotification({ userEmail, profile }) {
  return send({
    ...
    html: base({
      preheader: `${userEmail} vient de rejoindre la liste d'attente ADS-SQUARE.`,
      accentColor: '#E8A020',
      body: `
...
export async function sendLaunchEmail({ to, lang }) {
  ...
  return send({
    to,
    subject: isEn
      ? '◈ ADS-SQUARE is now open — your spot is waiting'
      : '◈ ADS-SQUARE est maintenant ouvert — votre place vous attend',
    html: base({
      preheader: isEn
        ? 'The ADS-SQUARE grid is now open. Book your advertising block today!'
        : 'La grille ADS-SQUARE est maintenant ouverte. Réservez votre bloc publicitaire dès aujourd\'hui !',
      accentColor: '#E8A020',
      body: `
        ...
        <div style="margin-top:16px;margin-bottom:28px;">
          ${subText(isEn
            ? `You signed up for early access — the moment has arrived.<br><br>
              ADS-SQUARE is now open to all advertisers. <strong style="color:#E8A020;">Reserve your block on the Dyson Sphere</strong> directly from the 3D grid, from €1/day, with no agency and no minimum budget.<br><br>
            ...
            : `Vous vous étiez inscrit·e pour un accès prioritaire — ce moment est arrivé.<br><br>
              ADS-SQUARE est maintenant ouvert à tous les annonceurs. <strong style="color:#E8A020;">Réservez votre bloc sur la Sphère de Dyson</strong> directement depuis la grille 3D, dès 1€/jour, sans agence et sans budget minimum.<br><br>
