...
export const translations = {
  ...
  // ─── Landing ─────────────────────────────────────────────────
  'landing.badge':     { fr: 'Accès ouvert · Réservez dès maintenant', en: 'Open access · Reserve now' },
  'landing.title1':    { fr: 'Votre marque au cœur', en: 'Your brand at the heart' },
  'landing.title2':    { fr: 'de la Sphère.', en: 'of the Sphere.' },
  'landing.sub':       { fr: '1 296 espaces publicitaires, du nano-drone à l\'épicentre. Un slot, une URL, un visuel — visible par tous les visiteurs de la grille. Sans agence, sans minimum budgétaire.', en: '1,296 advertising spaces, from nano-drone to epicenter. One slot, one URL, one visual — seen by every visitor on the grid. No agency, no budget minimum.' },
  'landing.stat.active':   { fr: 'blocs actifs',        en: 'active blocks' },
  'landing.stat.free':     { fr: 'blocs disponibles',   en: 'available blocks' },
  'landing.stat.tiers':    { fr: 'tiers ouverts',        en: 'open tiers' },
  ...
  'landing.stat.from':     { fr: 'dès / jour',           en: 'from / day' },
  ...
  // ─── Dashboard ────────────────────────────────────────────────
  'dash.title':        { fr: 'Mon Espace Annonceur', en: 'My Advertiser Space' },
  'dash.signout':      { fr: 'Déconnexion', en: 'Sign out' },
  'dash.bookings':     { fr: 'Mes réservations', en: 'My bookings' },
  'dash.active':       { fr: 'Actif', en: 'Active' },
  'dash.expired':      { fr: 'Expiré', en: 'Expired' },
  'dash.loading':      { fr: 'Chargement…', en: 'Loading…' },
  'dash.empty':        { fr: 'Aucune réservation', en: 'No bookings' },
  'dash.profile':      { fr: 'Mon profil', en: 'My profile' },
  'dash.save':         { fr: 'Sauvegarder', en: 'Save' },
  'dash.saving':       { fr: 'Sauvegarde…', en: 'Saving…' },
  'dash.saved':        { fr: 'Sauvegardé ✓', en: 'Saved ✓' },

  // ─── FAQ ──────────────────────────────────────────────────────
  'faq.title':         { fr: 'Questions fréquentes', en: 'Frequently Asked Questions' },
  'faq.subtitle':      { fr: 'Tout ce que vous devez savoir sur la plateforme ADS-SQUARE.', en: 'Everything you need to know about the ADS-SQUARE platform.' },

  // ─── Legal pages ──────────────────────────────────────────────
  'legal.back':        { fr: '← Retour à la grille', en: '← Back to grid' },
};
...
// ─── Re-exports depuis lib/i18n/index.js ──────────────────────────────────
// lib/i18n.js est résolu en priorité sur lib/i18n/ par Node.
// On re-exporte useT, LanguageSwitcher et I18nProvider ici pour que tous
// les imports `from 'lib/i18n'` fonctionnent sans modifier les fichiers appelants.
export { I18nProvider, useT, LanguageSwitcher } from './i18n/index.js';
